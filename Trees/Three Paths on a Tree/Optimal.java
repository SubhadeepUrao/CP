public class Main {
    ...
    private static void solve(FastScanner sc) {
        ...
        // multi-source BFS
        // branches cannot extend from both endpoints, otherwise it would be part of the diameter
        // therefore excluding a and b from the diameter to initiate multi-source BFS
        int curr = parent[b];
        while (curr != a) {
            q[++end] = curr;
            distFromPath[curr] = 0;
        ...
        distFromPath[a] = distFromPath[b] = 0;
